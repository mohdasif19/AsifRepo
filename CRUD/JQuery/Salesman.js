...
function EnterFocus(Source) {
    ...
    if (Source == "HANDsetvalue" || Source == "HANdiscount" || Source == "HANdiscount2" || Source == "DEPOsite" || Source == "PREpayment") {
        ...
        //var finaldiscount = discount1 + discount2;

        var Finalpayment = (parseFloat(handset) - (parseFloat(discount1) + parseFloat(discount2))) + (parseFloat(deposit) + parseFloat(prepayment))
